        ...
        <div className="flex items-center gap-4">
          <div className="relative">
            ...
            <input 
              ...
              className="pl-9 pr-4 py-2 text-sm bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-green-400 focus:ring-1 focus:ring-green-400 transition-all w-64"
            />
          </div>
          ...
          <button 
            ...
            className="bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 px-6 py-2 rounded font-bold text-sm transition-colors shadow-sm flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isExporting.active && isExporting.type === 'PDF' ? (
              <><Loader2 size={16} className="animate-spin" /> {isExporting.current}/{isExporting.total} PDFs</>
            ) : (
          ...
          <button 
            ...
            disabled={isExporting.active}
            className="bg-[#34a853] hover:bg-green-600 text-white px-6 py-2 rounded font-bold text-sm transition-colors shadow-sm flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
                ...
                <div key={preview.memberId} className="bg-white rounded-[24px] border border-gray-100 overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300">
                  <div className="bg-gray-50 p-4 border-b border-gray-100 flex items-center justify-between gap-3">
                     ...
                     <button
                       ...
                       className="px-3 py-1.5 flex items-center gap-1.5 bg-white text-xs font-bold text-gray-600 hover:text-green-600 hover:bg-green-50 rounded-lg shadow-sm border border-gray-200 transition-all shrink-0"
            ...
            <div className="bg-white px-8 py-5 flex items-center justify-between border-b border-gray-200 shrink-0 shadow-sm z-10">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="flex items-center gap-2 px-5 py-2.5 bg-white border border-gray-200 text-gray-700 font-bold rounded-xl hover:bg-gray-50 hover:text-green-600 transition-all disabled:opacity-50"
                >
                ...
                <button onClick={() => setSelectedHighRes(null)} className="p-2.5 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-xl transition-all">
                  <X size={24} />
                </button>
              </div>
            </div>
